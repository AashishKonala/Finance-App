                ...
                >
                  ...
                  <td className="px-5 py-3.5">
                    <div className="flex items-center gap-3">
                      <div className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 ${ICON_BG[tx.category] || "bg-slate-500/10"}`}>
                        <span className="text-sm">{tx.icon}</span>
                      </div>
                      <div>
                        <p className="text-sm font-medium text-gray-100 leading-none">{tx.name}</p>
                        <p className="text-[10px] font-mono text-gray-500 mt-1">{tx.desc}</p>
                      </div>
                    </div>
                  </td>
                  ...
                  {/* Date */}
                  <td className="px-5 py-3.5">
                    <p className="text-xs font-mono text-gray-400">{tx.date}</p>
                    <p className="text-[10px] font-mono text-gray-600 mt-0.5">{tx.time}</p>
                  </td>
